...
export default function BetCalculator() {
  ...
  const preFilledMessage = `Hi Bet Vault v10! I calculated my bet on the site: ${betType.toUpperCase()} position of ₹${stake} at odds ${odds}. Clean Profit: ₹${netProfit}. Please guide me to place this bet.`;
  const whatsappUrl = getWhatsAppLink(preFilledMessage);

  return (
    <section id="calculator" className="py-20 px-4 sm:px-6 relative amethyst-bg-mesh">
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-400/30 text-cyan-300 text-xs font-mono font-black uppercase">
            ...
            <span>INTERACTIVE PROFIT & ODDS TOOL</span>
          </div>
          ...
          <p className="text-slate-300 text-base leading-relaxed font-normal">
            Calculate your exact potential payout before staking a single rupee. Real-time Back & Lay odds calculation with zero hidden cut.
          </p>
        </div>

        {/* Calculator Main Box */}
        <div className="glass-holo-card rounded-3xl p-6 sm:p-10 max-w-4xl mx-auto border border-cyan-500/30 shadow-2xl">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button
                    ...
                    className={`py-3 px-4 rounded-xl text-xs font-black transition-all border flex items-center justify-center gap-2 ${
                      betType === "lay"
                        ? "bg-neonMagenta-500/20 border-neonMagenta-500 text-neonMagenta-300 shadow-lg shadow-neonMagenta-500/10"
                        : "bg-amethyst-900 border-slate-800 text-slate-400 hover:text-slate-200"
                    }`}
                  >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-2.5 bg-amethyst-900 rounded-lg appearance-none cursor-pointer accent-cyan-400"
                />
                ...
                <div className="grid grid-cols-4 gap-2 mt-3">
                  {[1000, 2500, 5000, 10000].map((preset) => (
                    <button
                      ...
                      className="py-1.5 px-2 text-[11px] font-mono font-bold rounded-xl bg-amethyst-900 border border-slate-800 text-slate-300 hover:border-cyan-400/50"
                    >
                      +₹{preset}
                    </button>
                  ))}
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="font-mono text-base font-black text-neonMagenta-400">
                    {odds.toFixed(2)}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-full bg-amethyst-900 border border-slate-800 rounded-xl p-3 text-slate-100 font-mono text-sm font-bold focus:border-cyan-400 outline-none"
                  />
                  <div className="flex items-center gap-1.5 shrink-0">
                    {[1.50, 1.85, 2.20, 3.50].map((presetOdds) => (
                      <button
                        ...
                        className="py-2.5 px-2.5 text-[11px] font-mono font-bold rounded-xl bg-amethyst-900 border border-slate-800 text-slate-300 hover:border-cyan-400/50"
                      >
                        {presetOdds}
                      </button>
                    ))}
            ...
            {/* Results Column */}
            <div className="md:col-span-6 p-6 rounded-2xl bg-amethyst-950 border border-slate-800 space-y-6">
              
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                <span className="text-xs font-mono font-bold text-slate-400">ESTIMATED RETURN BREAKDOWN</span>
                <span className="text-[10px] px-2.5 py-0.5 rounded-full bg-cyan-500/20 text-cyan-300 font-mono font-bold">
                  Zero Commission
                </span>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center text-xs pt-3 border-t border-slate-900">
                  ...
                  <span className="font-mono text-sm font-black text-neonMagenta-400">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-[11px] font-mono text-slate-400">
                  ...
                  <span className="text-cyan-300">1 : {odds.toFixed(2)}</span>
                </div>
                <div className="w-full h-2.5 bg-amethyst-900 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-gradient-to-r from-cyan-400 via-purple-500 to-neonMagenta-400 transition-all duration-300"
